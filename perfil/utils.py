...
def calcula_equilibrio_financeiro():
    ...
    try:
        percentual_gastos_essenciais = format(total_gastos_essenciais * 100 / total, ".2f")
        percentual_gastos_nao_essenciais = format(total_gastos_nao_essenciais * 100 / total, ".2f")
